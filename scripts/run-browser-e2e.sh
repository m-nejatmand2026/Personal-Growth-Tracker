...
GC_E2E_BASE_URL=http://127.0.0.1:8787/experience/2/ node --test tests/browser/experience2-logger.browser.js tests/browser/experience2-goals.browser.js tests/browser/experience2-progress.browser.js tests/browser/experience2-insights.browser.js tests/browser/experience2-journal.browser.js
