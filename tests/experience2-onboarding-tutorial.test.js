...
test('offline shell precaches optional onboarding and tutorial modules in the Experience 2 namespace',()=>{for(const asset of ['/experience/2/js/onboarding-control.js','/experience/2/css/onboarding-control.css','/experience/2/js/tutorial.js','/experience/2/css/tutorial.css'])assert.ok(sw.includes(`'${asset}'`),`${asset} must be precached`);assert.match(sw,/growth-compass-preview2-e2-v\d+/);assert.doesNotMatch(sw,/experience\/1|growth-compass-preview1/);});
