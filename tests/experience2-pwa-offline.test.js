...
test('Experience 2 PWA precaches implemented Today Plan and Goals presentation layers',()=>{for(const path of['/experience/2/css/today.css','/experience/2/css/today-first-run.css','/experience/2/css/plan.css','/experience/2/css/goals.css','/experience/2/js/views/today.js','/experience/2/js/views/plan.js','/experience/2/js/views/goals.js'])assert.match(sw,new RegExp(path.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')))});
...
test('Experience 2 API adapter prevents stale browser HTTP caching after mutations',()=>{assert.match(api,/fetch\(`\/api\$\{path\}`,\{cache:'no-store',\.\.\.options/);});
