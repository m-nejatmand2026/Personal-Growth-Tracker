...
const goals=await readFile(new URL('../public/experience/2/js/views/goals.js',import.meta.url),'utf8');

test('Goal archive confirmation releases modal UI before awaiting the network mutation',()=>{
