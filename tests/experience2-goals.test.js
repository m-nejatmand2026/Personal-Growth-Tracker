...
const facade=await readFile(new URL('../public/experience/2/js/views/goals.js',import.meta.url),'utf8');
const view=await readFile(new URL('../public/experience/2/js/views/direction.js',import.meta.url),'utf8');
...
const directionCss=await readFile(new URL('../public/experience/2/css/direction.css',import.meta.url),'utf8');
