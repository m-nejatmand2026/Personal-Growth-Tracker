...
export async function renderProgress({ reload, weeklyDirection = [] } = {}) {
  ...
  const historySection = `<section class="os-section progress-history-section"><div class="os-section-head"><div><h2>Recent</h2></div></div><div class="progress-history-list">${recentRows(history)}</div></section>`;
