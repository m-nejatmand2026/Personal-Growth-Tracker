...
export const journalModule=Object.freeze({
  ...
  renderView({model}){return `<section class="journal-hero journal-action-hero living-journal-hero" aria-labelledby="journalCurrentTitle"><div class="living-page-heading"><h2 id="journalCurrentTitle">Journal</h2><p>Write when there is something you want to remember.</p></div><div class="living-reflection-stats"><div><strong>${model.items.length}</strong><span>entries</span></div><div><strong>90</strong><span>day view</span></div></div><button type="button" class="journal-new" data-journal-write="${model.date}">＋ New reflection</button></section>
