...
export const journalModule=Object.freeze({
  ...
  renderView({model}){return `<section class="journal-hero journal-action-hero"><p class="gc-sr-only">Private reflection without streaks, points or optimization pressure.</p><button type="button" class="journal-new" data-journal-write="${model.date}">＋ New entry</button></section>
