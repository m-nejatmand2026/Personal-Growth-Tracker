...
export const journalCapability=Object.freeze({
  list({q='',limit=80,includeArchived=false}={}){const query=new URLSearchParams();if(q)query.set('q',q);query.set('limit',String(limit));if(includeArchived)query.set('include_archived','1');return api.get(`/v1/journal?${query}`);},
