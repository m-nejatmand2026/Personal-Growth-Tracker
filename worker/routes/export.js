...
import { exportDailyPlanV1 } from '../modules/daily-plan/public.js';
import { exportGoalsV1 } from '../modules/goals/public.js';
import { exportJournalV1 } from '../modules/journal/public.js';
import { exportPlansV1 } from '../modules/plans/public.js';
import { exportProgressV1 } from '../modules/progress/public.js';
import { exportWellbeingV1 } from '../modules/wellbeing/public.js';
...
export async function exportRoute({ request, env }) {
  ...
  const [
    ...
    exportActivitiesV1(env.DB, profileId),
    exportPlansV1(env.DB, profileId),
    exportCapacityV1(env.DB, profileId),
    exportDailyPlanV1(env.DB, profileId),
  ...
  return json({
    ...
    version_one: {
      ...
      plan_versions: plans.plan_versions,
      goal_plan_values: plans.goal_plan_values,
      capacity_commitments: commitments,
      progress_records: progressRecords,
      energy_logs: wellbeing.energy_logs,
      sleep_logs: wellbeing.sleep_logs,
      day_context_logs: wellbeing.day_context_logs,
